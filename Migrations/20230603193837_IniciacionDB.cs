...
{
    /// <inheritdoc />
    public partial class IniciacionDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlquileresDetalles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AlquileresDetalles_Alquileres_AlquilerId",
                        column: x => x.AlquilerId,
                        principalTable: "Alquileres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlquileresDetalles_Articulos_ArticuloId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlquileresDetalles_AlquilerId",
                table: "AlquileresDetalles",
                column: "AlquilerId");

            migrationBuilder.CreateIndex(
                name: "IX_AlquileresDetalles_ArticuloId",
                table: "AlquileresDetalles",
                column: "ArticuloId");
        }
